...
<!--
    ...
    Ejercicio 4 Array: Verbos irregulares en ingles.
...
<body>
    <header>
        <h1>Ejercicio 4: Verbos Irregulares en Ingles.</h1>
    </header>
    <section>
        <?php
            echo "<table border=1>";
            ...
            echo "</br><a href=\"https://github.com/cralr/DWES2021/blob/master/Tema1/EjemplosIniciales/Actividad2_4Array/Ejercicio4.php\"><button>Ver Código</button></a></br>";
